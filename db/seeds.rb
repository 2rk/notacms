...
Content.create(title: 'Home', top: 100, left: 200, height: 200, width: 250, content: 'campJS Rocks!!')
Content.create(title: 'About Us', top: 200, left: 300, height: 300, width: 200, content: 'Body of campJS 2')
...
Content.create(title: 'Products', top: 350, left: 400, height: 450, width: 300, content: 'Body of campJS 4')
Content.create(title: 'Our Staff', top: 200, left: 200, height: 250, width: 300, content: 'Body of campJS 5')